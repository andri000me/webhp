...
&nbsp;
<div class="alert alert-danger"><center>anda sudah terdaftar mohon isi lagi</center></div> 
...
<td><a class="btn btn-primary" href="form_beli_cash2.php?id=<?php echo $data['kode_mobil']; ?>"><span class="glyphicon glyphicon-shopping-cart"> Beli Cash</span></a> <a class="btn btn-primary" href="form_beli_kredit.php?id=<?php echo $data['kode_mobil']; ?>"><span class="glyphicon glyphicon-shopping-cart"> Beli Kredit</span></a></td>
</tr>
</tbody>
<?php
}
