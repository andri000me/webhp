...
<form action="beli_kredit.php" method="post">
...
<td><input class="form-control" type="text" name="tgl_kredit" value="<?php echo $tanggalbayar['cash_tgl']; ?>"  /></td>
</tr>
<tr>
<td><label>kode paket</label></td>
<td><input class="form-control" type="text" name="kode_paket" /></td>
</tr>
</tr>
<tr>
<tr>
<td><label>foto kopi ktp</label></td>
<td><input type="radio" value="belum"  name="fotokopi_ktp" />Belum <input name="fotokopi_ktp" type="radio" value="sudah" /> sudah</td>
</tr>
</tr>
<tr>
<td><label>foto kopi kk</label></td>
<td><input type="radio" value="belum"  name="fotokopi_ktp" />Belum <input name="fotokopi_kk" type="radio" value="sudah" /> sudah</td>
</tr>
<tr>
<td><label>fotokopi slip gaji</label></td>
<td><input type="radio" value="belum"  name="fotokopi_ktp" />Belum <input name="fotokopi_slip_gaji" type="radio" value="sudah" /> sudah</td>
</tr>
<tr>
